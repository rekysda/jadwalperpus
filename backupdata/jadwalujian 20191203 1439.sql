...
--
-- Create schema jadwalujian
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ jadwalujian;
USE jadwalujian;

--
-- Table structure for table `jadwalujian`.`actions`
--
...
--
-- Dumping data for table `jadwalujian`.`actions`
--
...
--
-- Table structure for table `jadwalujian`.`admin`
--
...
--
-- Dumping data for table `jadwalujian`.`admin`
--
...
--
-- Table structure for table `jadwalujian`.`guru_dinilai`
--

DROP TABLE IF EXISTS `guru_dinilai`;
CREATE TABLE `guru_dinilai` (
...
--
-- Dumping data for table `jadwalujian`.`guru_dinilai`
--

/*!40000 ALTER TABLE `guru_dinilai` DISABLE KEYS */;
/*!40000 ALTER TABLE `guru_dinilai` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`guru_isi`
--

DROP TABLE IF EXISTS `guru_isi`;
CREATE TABLE `guru_isi` (
  `id` int(2) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jadwalujian`.`guru_isi`
--

/*!40000 ALTER TABLE `guru_isi` DISABLE KEYS */;
...
INSERT INTO `guru_isi` (`id`,`kelas`,`guru`) VALUES 
 ...
 (449,'17','maria'),
 (450,'18','maria');
/*!40000 ALTER TABLE `guru_isi` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`infoguru`
--

DROP TABLE IF EXISTS `infoguru`;
CREATE TABLE `infoguru` (
...
--
-- Dumping data for table `jadwalujian`.`infoguru`
--

/*!40000 ALTER TABLE `infoguru` DISABLE KEYS */;
/*!40000 ALTER TABLE `infoguru` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`intrusions`
--
...
--
-- Dumping data for table `jadwalujian`.`intrusions`
--
...
--
-- Table structure for table `jadwalujian`.`jadwalstatus`
--

DROP TABLE IF EXISTS `jadwalstatus`;
CREATE TABLE `jadwalstatus` (
...
--
-- Dumping data for table `jadwalujian`.`jadwalstatus`
--

/*!40000 ALTER TABLE `jadwalstatus` DISABLE KEYS */;
INSERT INTO `jadwalstatus` (`id`,`nama`) VALUES 
 (1,'Belum Konfirmasi'),
 (2,'Aktif'),
 (3,'Batal');
/*!40000 ALTER TABLE `jadwalstatus` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`jadwalujian`
--
...
--
-- Dumping data for table `jadwalujian`.`jadwalujian`
--
...
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (136,'2019-08-26 13:00:00','2','XII-MIPA1 - Biologi UH 2 ( Jam Ke8) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','19','9','3','1'),
 (137,'2019-08-26 13:40:00','2','XII-MIPA1 - Biologi UH 2 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','19','10','3','1'),
 (138,'2019-08-26 13:00:00','2','XI-MIPA2 - Sejarah Indonesia UH 1 ( Jam Ke8) - Albertus Handang Budi Karya , S.Pd. - LABKOM 3 (Lantai 3)','albertushandang','55','11','9','2','3'),
 (139,'2019-08-26 13:40:00','2','XI-MIPA2 - Sejarah Indonesia UH 1 ( Jam Ke9) - Albertus Handang Budi Karya , S.Pd. - LABKOM 3 (Lantai 3)','albertushandang','55','11','10','2','3'),
 (140,'2019-08-27 12:20:00','2','X-MIPA1 - Biologi UH 2 ( Jam Ke7) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','1','8','3','1'),
 (141,'2019-08-29 09:50:00','2','X-MIPA3 - Biologi UH 2 ( Jam Ke4) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','3','5','3','1'),
 (142,'2019-08-29 12:20:00','2','X-MIPA4 - Biologi UH 2 ( Jam Ke7) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','4','8','3','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (143,'2019-08-29 13:40:00','2','X-MIPA2 - Biologi UH 2 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','2','10','3','1'),
 (146,'2019-09-02 10:30:00','2','XII-MIPA4 - Biologi UH 1 (Remidi) ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','6','5','1'),
 (147,'2019-09-02 11:10:00','2','XII-MIPA4 - Biologi UH 1 (Remidi) ( Jam Ke6) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','7','5','1'),
 (148,'2019-09-02 13:00:00','2','XII-MIPA2 - Biologi UH 1 (Remidi) ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','9','5','1'),
 (149,'2019-09-02 13:40:00','2','XII-MIPA2 - Biologi UH 1 (Remidi) ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','10','5','1'),
 (152,'2019-09-03 13:00:00','2','XII-MIPA3 - Biologi UH 1 (Remidi) ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','9','5','1'),
 (153,'2019-09-03 13:40:00','2','XII-MIPA3 - Biologi UH 1 (Remidi) ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','10','5','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (158,'2019-09-03 09:50:00','2','XII-MIPA2 - Biologi UH 2 ( Jam Ke4) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','5','3','1'),
 (159,'2019-09-03 10:30:00','2','XII-MIPA2 - Biologi UH 2 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','6','3','1'),
 (160,'2019-09-04 12:20:00','2','XII-MIPA4 - Biologi UH 2 ( Jam Ke7) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','8','3','1'),
 (161,'2019-09-04 13:00:00','2','XII-MIPA4 - Biologi UH 2 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','9','3','1'),
 (164,'2019-08-27 13:00:00','2','XI-MIPA1 - Sejarah Indonesia UH 1 ( Jam Ke8) - Albertus Handang Budi Karya , S.Pd. - LABKOM 1 (Lantai 1)','albertushandang','55','10','9','2','1'),
 (165,'2019-08-27 13:40:00','2','XI-MIPA1 - Sejarah Indonesia UH 1 ( Jam Ke9) - Albertus Handang Budi Karya , S.Pd. - LABKOM 1 (Lantai 1)','albertushandang','55','10','10','2','1'),
 (166,'2019-08-28 11:10:00','2','X-IPS2 - PKWU/Ekonomi UH 1 ( Jam Ke6) - Markus Tri Wibowo , S.Pd. - LABKOM 1 (Lantai 1)','markustri','58','7','7','2','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (167,'2019-09-05 00:00:00','2','XII-MIPA3 - Fisika UH 2 ( Jam Ke1) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','21','1','3','1'),
 (168,'2019-09-05 00:00:00','2','XII-MIPA3 - Fisika UH 2 ( Jam Ke2) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','21','2','3','1'),
 (169,'2019-09-05 09:50:00','2','XII-MIPA4 - Fisika UH 2 ( Jam Ke4) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','22','5','3','1'),
 (170,'2019-09-05 10:30:00','2','XII-MIPA4 - Fisika UH 2 ( Jam Ke5) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','22','6','3','1'),
 (171,'2019-09-05 11:10:00','2','XII-NSC - Fisika UH 2 ( Jam Ke6) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','25','7','3','1'),
 (172,'2019-09-05 12:20:00','2','XII-NSC - Fisika UH 2 ( Jam Ke7) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','25','8','3','1'),
 (173,'2019-08-29 00:00:00','2','XI-MIPA4 - Sejarah Indonesia UH 1 ( Jam Ke1) - Albertus Handang Budi Karya , S.Pd. - LABKOM 1 (Lantai 1)','albertushandang','55','14','1','2','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (174,'2019-08-29 00:00:00','2','XI-MIPA4 - Sejarah Indonesia UH 1 ( Jam Ke2) - Albertus Handang Budi Karya , S.Pd. - LABKOM 1 (Lantai 1)','albertushandang','55','14','2','2','1'),
 (175,'2019-08-29 10:30:00','3','X-NSC - PKWU/Ekonomi UH 1 ( Jam Ke5) - Markus Tri Wibowo , S.Pd. - LABKOM 3 (Lantai 3)','markustri','58','9','6','2','3'),
 (176,'2019-08-29 09:50:00','2','X-NSC - PKWU/Ekonomi UH 1 ( Jam Ke4) - Markus Tri Wibowo , S.Pd. - LABKOM 3 (Lantai 3)','markustri','58','9','5','2','3'),
 (177,'0000-00-00 00:00:00','3','XII-SSC - PKWU/Ekonomi UH 1 ( Jam Ke1) - Markus Tri Wibowo , S.Pd. - LABKOM 3 (Lantai 3)','markustri','58','33','1','2','3'),
 (178,'2019-09-02 13:40:00','3','X-IPS1 - PKWU/Ekonomi UH 1 ( Jam Ke9) - Markus Tri Wibowo , S.Pd. - LABKOM 3 (Lantai 3)','markustri','58','6','10','2','3'),
 (181,'2019-09-06 00:00:00','2','XII-MIPA1 - Biologi UH 3 ( Jam Ke1) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','19','1','4','1'),
 (182,'2019-09-04 11:10:00','2','X-NSC - Biologi UH 2 ( Jam Ke6) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','9','7','3','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (183,'0000-00-00 00:00:00','2','X-IPS1 - PKWU/Ekonomi UH 1 ( Jam Ke9) - Markus Tri Wibowo , S.Pd. - LABKOM 1 (Lantai 1)','markustri','58','6','10','2','1'),
 (184,'2019-09-10 13:00:00','2','XII-MIPA3 - Biologi UH 2 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','9','3','1'),
 (185,'2019-09-10 13:40:00','2','XII-MIPA3 - Biologi UH 2 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','10','3','1'),
 (186,'2019-09-09 00:00:00','2','XII-IPS2 - Geografi UH 1 ( Jam Ke1) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','27','1','2','1'),
 (188,'0000-00-00 00:00:00','2','XII-IPS1 - Sosiologi/Antropologi UH 2 ( Jam Ke5) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','26','6','3','2'),
 (189,'2019-09-05 11:10:00','3','XII-IPS1 - Sosiologi/Antropologi UH 2 ( Jam Ke6) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','26','7','3','2'),
 (190,'2019-09-09 00:00:00','2','XII-IPS2 - Geografi UH 1 ( Jam Ke2) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','27','2','2','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (191,'2019-09-09 12:20:00','2','XII-IPS3 - Geografi UH 1 ( Jam Ke7) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','28','8','2','1'),
 (192,'2019-09-09 13:00:00','2','XII-IPS3 - Geografi UH 1 ( Jam Ke8) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','28','9','2','1'),
 (193,'2019-09-10 00:00:00','2','X-NSC - Geografi UH 1 ( Jam Ke1) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','9','1','2','1'),
 (194,'2019-09-10 00:00:00','2','X-NSC - Geografi UH 1 ( Jam Ke2) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','9','2','2','1'),
 (195,'2019-09-05 10:30:00','2','XII-IPS1 - Sosiologi/Antropologi UH 2 ( Jam Ke5) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 3 (Lantai 3)','evarenanthya','47','26','6','3','3'),
 (196,'2019-09-05 11:10:00','2','XII-IPS1 - Sosiologi/Antropologi UH 2 ( Jam Ke6) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 3 (Lantai 3)','evarenanthya','47','26','7','3','3'),
 (197,'2019-09-11 07:45:00','2','X-MIPA3 - Geografi UH 1 ( Jam Ke1) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','3','1','2','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (198,'2019-09-11 08:30:00','2','X-MIPA3 - Geografi UH 1 ( Jam Ke2) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','3','2','2','1'),
 (199,'2019-09-11 09:10:00','2','X-MIPA1 - Geografi UH 1 ( Jam Ke3) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','1','4','2','1'),
 (200,'2019-09-11 09:50:00','2','X-MIPA1 - Geografi UH 1 ( Jam Ke4) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','1','5','2','1'),
 (201,'2019-09-12 00:00:00','2','X-MIPA2 - Geografi UH 1 ( Jam Ke1) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','2','1','2','1'),
 (202,'2019-09-12 00:00:00','2','X-MIPA2 - Geografi UH 1 ( Jam Ke2) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','2','2','2','1'),
 (203,'2019-09-13 00:00:00','2','X-MIPA4 - Geografi UH 1 ( Jam Ke1) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','4','1','2','1'),
 (204,'2019-09-13 00:00:00','2','X-MIPA4 - Geografi UH 1 ( Jam Ke2) - Drs. Bernadus Edy Gunarso - LABKOM 1 (Lantai 1)','bernadusedy','8','4','2','2','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (207,'2019-09-06 09:50:00','2','XI-NSC - Fisika UH 1 ( Jam Ke4) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','12','5','2','1'),
 (208,'2019-09-06 09:10:00','2','XI-NSC - Fisika UH 1 ( Jam Ke3) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','12','4','2','1'),
 (209,'2019-09-06 10:30:00','2','XI-MIPA4 - Fisika UH 1 ( Jam Ke5) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','14','6','2','1'),
 (210,'2019-09-06 11:10:00','2','XI-MIPA4 - Fisika UH 1 ( Jam Ke6) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','14','7','2','1'),
 (211,'2019-09-12 00:00:00','2','XII-SSC - Fisika UH 1 (Remidi) ( Jam Ke1) - Theresia Anata, S. Pd. - LABKOM 2 (Lantai 3)','theresiaanata','41','33','1','5','2'),
 (212,'2019-09-12 00:00:00','2','XII-MIPA3 - Fisika UH 2 (Remidi) ( Jam Ke2) - Theresia Anata, S. Pd. - LABKOM 2 (Lantai 3)','theresiaanata','41','21','2','6','2'),
 (213,'2019-09-12 09:50:00','2','XII-MIPA4 - Fisika UH 1 (Remidi) ( Jam Ke4) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','22','5','5','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (214,'2019-09-12 10:30:00','2','XII-MIPA4 - Fisika UH 1 (Remidi) ( Jam Ke5) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','22','6','5','1'),
 (215,'2019-09-12 11:10:00','2','XII-NSC - Fisika UH 1 (Remidi) ( Jam Ke6) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','25','7','5','1'),
 (216,'2019-09-12 12:20:00','2','XII-NSC - Fisika UH 2 (Remidi) ( Jam Ke7) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','25','8','6','1'),
 (217,'2019-09-13 09:10:00','2','XI-NSC - Fisika UH 1 (Remidi) ( Jam Ke3) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','12','4','5','1'),
 (218,'2019-09-13 09:50:00','2','XI-NSC - Fisika UH 2 (Remidi) ( Jam Ke4) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','12','5','6','1'),
 (219,'2019-09-13 10:30:00','2','XI-MIPA4 - Fisika UH 1 (Remidi) ( Jam Ke5) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','14','6','5','1'),
 (220,'2019-09-13 11:10:00','2','XI-MIPA4 - Fisika UH 2 (Remidi) ( Jam Ke6) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','14','7','6','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (226,'2019-09-11 12:20:00','2','XII-MIPA4 - Biologi UH 2 (Remidi) ( Jam Ke7) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 3 (Lantai 3)','henrikadwi','57','22','8','6','3'),
 (227,'2019-09-11 13:00:00','2','XII-MIPA4 - Biologi UH 2 (Remidi) ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 3 (Lantai 3)','henrikadwi','57','22','9','6','3'),
 (228,'2019-09-12 13:00:00','2','XII-MIPA3 - Biologi UH 2 (Remidi) ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','9','6','1'),
 (229,'2019-09-12 13:40:00','2','XII-MIPA3 - Biologi UH 2 (Remidi) ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','10','6','1'),
 (230,'2019-09-10 09:50:00','2','XII-MIPA2 - Biologi UH 2 (Remidi) ( Jam Ke4) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','5','6','1'),
 (231,'2019-09-10 10:30:00','2','XII-MIPA2 - Biologi UH 2 (Remidi) ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','6','6','1'),
 (232,'2019-09-09 13:00:00','2','XII-IPS2 - Sosiologi/Antropologi UH 2 ( Jam Ke8) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 3 (Lantai 3)','evarenanthya','47','27','9','3','3');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (233,'2019-09-09 13:40:00','2','XII-IPS2 - Sosiologi/Antropologi UH 2 ( Jam Ke9) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 3 (Lantai 3)','evarenanthya','47','27','10','3','3'),
 (234,'0000-00-00 00:00:00','2','X-NSC - PKWU/Ekonomi UH 1 (Remidi) ( Jam Ke7) - Markus Tri Wibowo , S.Pd. - LABKOM 3 (Lantai 3)','markustri','58','9','8','5','3'),
 (235,'2019-09-09 12:20:00','2','X-NSC - PKWU/Ekonomi UH 1 (Remidi) ( Jam Ke7) - Markus Tri Wibowo , S.Pd. - LABKOM 3 (Lantai 3)','markustri','58','9','8','5','3'),
 (237,'2019-09-12 11:10:00','2','XII-MIPA2 - Matematika/Matematika Minat UH 1 ( Jam Ke6) - Stephanus Sulistyantoro , M.Pd. - LABKOM 3 (Lantai 3)','stephanussulistyantoro','82','20','7','2','3'),
 (238,'2019-09-12 12:20:00','2','XII-MIPA2 - Matematika/Matematika Minat UH 1 ( Jam Ke7) - Stephanus Sulistyantoro , M.Pd. - LABKOM 3 (Lantai 3)','stephanussulistyantoro','82','20','8','2','3'),
 (239,'2019-09-12 13:00:00','2','XII-IPS1 - Matematika/Matematika Minat UH 1 ( Jam Ke8) - Stephanus Sulistyantoro , M.Pd. - LABKOM 3 (Lantai 3)','stephanussulistyantoro','82','26','9','2','3');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (240,'2019-09-12 13:40:00','2','XII-IPS1 - Matematika/Matematika Minat UH 1 ( Jam Ke9) - Stephanus Sulistyantoro , M.Pd. - LABKOM 3 (Lantai 3)','stephanussulistyantoro','82','26','10','2','3'),
 (241,'2019-09-11 09:10:00','2','XII-MIPA1 - Matematika/Matematika Minat UH 1 ( Jam Ke3) - Stephanus Sulistyantoro , M.Pd. - LABKOM 3 (Lantai 3)','stephanussulistyantoro','82','19','4','2','3'),
 (242,'2019-09-11 09:50:00','2','XII-MIPA1 - Matematika/Matematika Minat UH 1 ( Jam Ke4) - Stephanus Sulistyantoro , M.Pd. - LABKOM 3 (Lantai 3)','stephanussulistyantoro','82','19','5','2','3'),
 (243,'2019-09-11 10:30:00','2','XII-IPS3 - Sosiologi/Antropologi UH 2 ( Jam Ke5) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','28','6','3','1'),
 (244,'2019-09-11 11:10:00','2','XII-IPS3 - Sosiologi/Antropologi UH 2 ( Jam Ke6) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','28','7','3','1'),
 (245,'2019-09-13 07:00:00','2','PPDB - Fisika UH 1 ( Jam Ke1) - Laurentius Wahyudiarjo , S.Pd. - LABKOM 3 (Lantai 3)','laurentiuswahyudiarjo','83','30','1','2','3');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (246,'2019-09-13 07:40:00','2','PPDB - Fisika UH 1 ( Jam Ke2) - Laurentius Wahyudiarjo , S.Pd. - LABKOM 3 (Lantai 3)','laurentiuswahyudiarjo','83','30','2','2','3'),
 (247,'2019-09-13 09:10:00','2','PPDB - Fisika UH 1 ( Jam Ke3) - Laurentius Wahyudiarjo , S.Pd. - LABKOM 3 (Lantai 3)','laurentiuswahyudiarjo','83','30','4','2','3'),
 (248,'2019-09-13 09:50:00','2','PPDB - Fisika UH 1 ( Jam Ke4) - Laurentius Wahyudiarjo , S.Pd. - LABKOM 3 (Lantai 3)','laurentiuswahyudiarjo','83','30','5','2','3'),
 (249,'2019-10-14 07:40:00','2','X-IPS1 - Bhs. Inggris/BDSI UH 1 (Remidi) ( Jam Ke2) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','6','2','5','1'),
 (250,'2019-10-14 09:10:00','2','X-IPS1 - Bhs. Inggris/BDSI UH 1 (Remidi) ( Jam Ke3) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','6','4','5','1'),
 (251,'2019-10-14 10:30:00','2','XII-MIPA2 - Bhs. Inggris/BDSI UH 1 (Remidi) ( Jam Ke5) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','20','6','5','1'),
 (252,'2019-10-14 13:00:00','2','X-MIPA3 - Bhs. Inggris/BDSI UH 1 (Remidi) ( Jam Ke8) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','3','9','5','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (253,'2019-10-14 13:40:00','2','X-MIPA3 - Bhs. Inggris/BDSI UH 1 (Remidi) ( Jam Ke9) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','3','10','5','1'),
 (254,'2019-10-15 07:00:00','2','X-SSC - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke1) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','31','1','5','1'),
 (255,'2019-10-15 09:10:00','2','X-IPS1 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke3) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','6','4','5','1'),
 (256,'2019-10-15 10:30:00','2','X-IPS2 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke5) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','7','6','5','1'),
 (257,'2019-10-15 07:40:00','2','X-SSC - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke2) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','31','2','5','1'),
 (258,'2019-10-15 09:50:00','2','X-IPS1 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke4) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','6','5','5','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (259,'2019-10-15 11:10:00','2','X-IPS2 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke6) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','7','7','5','1'),
 (260,'2019-10-15 12:20:00','2','X-MIPA2 - Bhs. Inggris/BDSI UH 1 (Remidi) ( Jam Ke7) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','2','8','5','1'),
 (261,'2019-10-15 13:00:00','2','X-MIPA1 - Bhs. Inggris/BDSI UH 1 (Remidi) ( Jam Ke8) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','1','9','5','1'),
 (262,'2019-10-15 13:40:00','2','X-MIPA1 - Bhs. Inggris/BDSI UH 1 (Remidi) ( Jam Ke9) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','1','10','5','1'),
 (265,'2019-10-16 07:00:00','2','XII-IPS3 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke1) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','28','1','5','1'),
 (266,'0000-00-00 00:00:00','2','XII-IPS1 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke4) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','26','5','5','1'),
 (267,'2019-10-16 09:10:00','2','XII-IPS1 - Sosiologi/Antropologi PTS (Remidi) ( Jam Ke3) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','26','4','12','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (268,'2019-10-16 09:50:00','2','XII-IPS1 - Sosiologi/Antropologi PTS (Remidi) ( Jam Ke4) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','26','5','12','1'),
 (269,'2019-10-16 07:40:00','2','XII-MIPA2 - Bhs. Inggris/BDSI PTS (Remidi) ( Jam Ke2) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','20','2','12','1'),
 (270,'2019-10-16 13:00:00','2','XI-IPS1 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke8) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','16','9','5','1'),
 (271,'2019-10-16 13:40:00','2','XI-IPS1 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke9) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','16','10','5','1'),
 (272,'2019-10-17 09:10:00','2','X-SSC - Bhs. Inggris/BDSI PTS (Remidi) ( Jam Ke3) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','31','4','12','1'),
 (273,'2019-10-18 09:10:00','2','XII-MIPA1 - Bhs. Inggris/BDSI PTS (Remidi) ( Jam Ke3) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','19','4','12','1'),
 (274,'2019-10-18 09:50:00','2','XII-MIPA1 - Bhs. Inggris/BDSI PTS (Remidi) ( Jam Ke4) - Heru Purnomo - LABKOM 1 (Lantai 1)','herupurnomo','67','19','5','12','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (275,'0000-00-00 00:00:00','2','XII-IPS2 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke3) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','27','4','5','2'),
 (276,'2019-10-17 09:50:00','2','XII-IPS2 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke4) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','27','5','5','2'),
 (277,'2019-10-17 11:10:00','3','XI-IPS2 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke6) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','17','7','5','1'),
 (278,'2019-10-17 12:20:00','2','XI-IPS2 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke7) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','17','8','5','1'),
 (279,'2019-10-17 13:00:00','2','XI-IPS3 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke8) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','18','9','5','1'),
 (280,'2019-10-17 13:40:00','2','XI-IPS3 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke9) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','18','10','5','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (281,'2019-10-17 09:10:00','2','XII-IPS2 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke3) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','27','4','5','2'),
 (282,'2019-10-18 12:20:00','2','XI-MIPA3 - Fisika PTS (Remidi) ( Jam Ke7) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','13','8','12','1'),
 (283,'2019-10-18 13:00:00','2','XI-MIPA3 - Fisika PTS (Remidi) ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','13','9','12','1'),
 (284,'2019-10-18 07:00:00','2','XI-IPS2 - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke1) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','17','1','5','1'),
 (285,'2019-10-18 07:40:00','2','XII-SSC - Sosiologi/Antropologi UH 1 (Remidi) ( Jam Ke2) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','33','2','5','1'),
 (288,'2019-10-23 07:00:00','2','XII-MIPA3 - Fisika UH 3 ( Jam Ke1) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','21','1','4','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (289,'2019-10-23 07:40:00','2','XII-MIPA3 - Fisika UH 3 ( Jam Ke2) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','21','2','4','1'),
 (290,'2019-10-23 09:10:00','2','XII-MIPA4 - Fisika UH 3 ( Jam Ke3) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','22','4','4','1'),
 (291,'2019-10-23 09:50:00','2','XII-MIPA4 - Fisika UH 3 ( Jam Ke4) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','22','5','4','1'),
 (292,'2019-10-23 11:10:00','2','XII-NSC - Fisika UH 3 ( Jam Ke6) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','25','7','4','1'),
 (293,'2019-10-23 12:20:00','2','XII-NSC - Fisika UH 3 ( Jam Ke7) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','25','8','4','1'),
 (296,'2019-10-18 09:50:00','2','XI-MIPA4 - Fisika UH 3 ( Jam Ke4) - Theresia Anata, S. Pd. - LABKOM 3 (Lantai 3)','theresiaanata','41','14','5','4','3'),
 (297,'2019-10-18 09:10:00','2','XI-MIPA4 - Fisika UH 3 ( Jam Ke3) - Theresia Anata, S. Pd. - LABKOM 3 (Lantai 3)','theresiaanata','41','14','4','4','3');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (298,'2019-10-23 13:00:00','2','XII-MIPA2 - Biologi UH 3 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','9','4','1'),
 (299,'2019-10-23 13:40:00','2','XII-MIPA2 - Biologi UH 3 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','10','4','1'),
 (301,'2019-10-22 13:00:00','2','XII-MIPA4 - Biologi UH 3 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','9','4','1'),
 (302,'2019-10-22 13:40:00','2','XII-MIPA4 - Biologi UH 3 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','10','4','1'),
 (305,'2019-10-21 10:30:00','2','X-MIPA4 - Fisika UH 3 ( Jam Ke5) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','4','6','4','1'),
 (306,'2019-10-21 11:10:00','2','X-MIPA4 - Fisika UH 3 ( Jam Ke6) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','4','7','4','1'),
 (307,'2019-10-21 13:00:00','2','XI-MIPA1 - Fisika UH 3 ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','10','9','4','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (308,'2019-10-21 13:40:00','2','XI-MIPA1 - Fisika UH 3 ( Jam Ke9) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','10','10','4','1'),
 (309,'2019-10-22 09:10:00','2','XI-MIPA2 - Fisika UH 3 ( Jam Ke3) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','11','4','4','1'),
 (310,'2019-10-22 09:50:00','2','XI-MIPA2 - Fisika UH 3 ( Jam Ke4) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','11','5','4','1'),
 (311,'2019-10-24 11:10:00','2','X-MIPA2 - Fisika UH 3 ( Jam Ke6) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','2','7','4','1'),
 (312,'2019-10-24 12:20:00','2','X-MIPA2 - Fisika UH 3 ( Jam Ke7) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','2','8','4','1'),
 (313,'2019-10-25 09:50:00','2','X-MIPA1 - Fisika UH 3 ( Jam Ke4) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','1','5','4','1'),
 (314,'2019-10-25 10:30:00','2','X-MIPA1 - Fisika UH 3 ( Jam Ke5) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','1','6','4','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (315,'2019-10-23 13:00:00','2','X-MIPA3 - Fisika UH 3 ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 3 (Lantai 3)','melianapantouw','70','3','9','4','3'),
 (316,'2019-10-23 13:40:00','2','X-MIPA3 - Fisika UH 3 ( Jam Ke9) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 3 (Lantai 3)','melianapantouw','70','3','10','4','3'),
 (317,'0000-00-00 00:00:00','2','XII-SSC - Biologi UH4 ( Jam Ke1) - Christina Handoyo, S.Si - LABKOM 3 (Lantai 3)','christinahandoyo','20','33','1','10','3'),
 (320,'2019-10-23 07:00:00','2','XII-MIPA1 - Biologi UH4 ( Jam Ke1) - Christina Handoyo, S.Si - LABKOM 3 (Lantai 3)','christinahandoyo','20','19','1','10','3'),
 (321,'2019-10-23 07:40:00','2','XII-MIPA1 - Biologi UH4 ( Jam Ke2) - Christina Handoyo, S.Si - LABKOM 3 (Lantai 3)','christinahandoyo','20','19','2','10','3'),
 (322,'2019-10-30 13:40:00','2','X-MIPA1 - Biologi UH4 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','1','10','10','1'),
 (323,'2019-10-30 12:20:00','2','X-MIPA2 - Biologi UH4 ( Jam Ke7) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','2','8','10','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (324,'2019-10-29 07:00:00','2','X-MIPA3 - Biologi UH4 ( Jam Ke1) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','3','1','10','1'),
 (325,'2019-10-30 09:50:00','2','X-MIPA4 - Biologi UH4 ( Jam Ke4) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','4','5','10','1'),
 (326,'2019-11-05 13:40:00','2','X-NSC - Biologi UH4 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','9','10','10','1'),
 (327,'2019-10-24 10:30:00','2','XII-MIPA2 - Biologi UH 3 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','6','4','1'),
 (328,'2019-10-24 13:00:00','2','XII-MIPA4 - Biologi UH 3 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','9','4','1'),
 (329,'2019-10-24 13:40:00','2','XII-MIPA4 - Biologi UH 3 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','10','4','1'),
 (330,'2019-10-23 10:30:00','2','XII-MIPA3 - Biologi UH 3 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','6','4','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (331,'0000-00-00 00:00:00','2','XII-MIPA3 - Biologi UH 3 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 3 (Lantai 3)','henrikadwi','57','21','6','4','3'),
 (333,'2019-10-30 13:00:00','2','XII-MIPA2 - Biologi UH4 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','9','10','1'),
 (334,'2019-10-30 10:30:00','2','XII-MIPA3 - Biologi UH4 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','6','10','1'),
 (335,'2019-10-30 11:10:00','2','XII-MIPA3 - Biologi UH4 ( Jam Ke6) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','7','10','1'),
 (336,'2019-10-29 13:00:00','2','XII-MIPA4 - Biologi UH4 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','9','10','1'),
 (337,'2019-10-29 13:40:00','2','XII-MIPA4 - Biologi UH4 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','10','10','1'),
 (338,'2019-10-28 12:20:00','2','XI-MIPA4 - Fisika UH4 ( Jam Ke7) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','14','8','10','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (339,'2019-10-28 13:00:00','2','XI-MIPA4 - Fisika UH4 ( Jam Ke8) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','14','9','10','1'),
 (340,'2019-10-28 13:40:00','2','XI-NSC - Fisika UH4 ( Jam Ke9) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','12','10','10','1'),
 (341,'2019-10-28 09:10:00','2','X-MIPA3 - Fisika UH4 ( Jam Ke3) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','3','4','10','1'),
 (342,'2019-10-28 10:30:00','2','X-MIPA4 - Fisika UH4 ( Jam Ke5) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','4','6','10','1'),
 (343,'2019-10-31 09:10:00','2','XI-NSC - Biologi UH 3 ( Jam Ke3) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','12','4','4','1'),
 (344,'2019-10-30 07:00:00','2','XII-MIPA1 - Biologi UH4 ( Jam Ke1) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','19','1','10','1'),
 (345,'2019-10-30 07:40:00','2','XII-MIPA1 - Biologi UH4 ( Jam Ke2) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','19','2','10','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (346,'2019-10-31 11:10:00','2','X-MIPA2 - Fisika UH4 ( Jam Ke6) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','2','7','10','1'),
 (347,'2019-11-01 07:00:00','2','XI-MIPA2 - Fisika UH 3 ( Jam Ke1) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','11','1','4','1'),
 (348,'2019-11-01 09:50:00','2','X-MIPA1 - Fisika UH4 ( Jam Ke4) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','1','5','10','1'),
 (349,'2019-11-01 12:20:00','2','XI-MIPA3 - Fisika UH 3 ( Jam Ke7) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','13','8','4','1'),
 (350,'2019-11-13 09:50:00','2','X-MIPA4 - Biologi UH 5 ( Jam Ke4) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','4','5','14','1'),
 (351,'2019-11-13 12:20:00','2','XI-MIPA2 - Biologi UH 5 ( Jam Ke7) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','11','8','14','1'),
 (352,'2019-11-13 13:40:00','2','X-MIPA1 - Biologi UH 5 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','1','10','14','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (353,'2019-11-14 10:30:00','2','X-MIPA3 - Biologi UH 5 ( Jam Ke5) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','3','6','14','1'),
 (354,'2019-11-14 13:00:00','2','X-MIPA2 - Biologi UH 5 ( Jam Ke8) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','2','9','14','1'),
 (355,'2019-11-07 09:10:00','2','X-MIPA4 - Fisika UH 5 ( Jam Ke3) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','4','4','14','1'),
 (356,'2019-11-07 11:10:00','2','X-MIPA2 - Fisika UH 5 ( Jam Ke6) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','2','7','14','1'),
 (357,'2019-11-08 07:00:00','2','XI-MIPA2 - Fisika UH 5 ( Jam Ke1) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','11','1','14','1'),
 (358,'2019-11-07 07:40:00','2','XI-MIPA2 - Fisika UH 5 ( Jam Ke2) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','11','2','14','1'),
 (359,'2019-11-08 09:50:00','2','X-MIPA1 - Fisika UH 5 ( Jam Ke4) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','1','5','14','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (360,'2019-11-08 12:20:00','2','XI-MIPA3 - Fisika UH 5 ( Jam Ke7) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','13','8','14','1'),
 (361,'2019-11-08 13:00:00','2','XI-MIPA3 - Fisika UH 5 ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','13','9','14','1'),
 (362,'2019-11-08 07:40:00','2','XI-MIPA2 - Fisika UH 5 ( Jam Ke2) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','11','2','14','1'),
 (363,'2019-11-11 09:10:00','2','X-MIPA3 - Fisika UH 5 ( Jam Ke3) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','3','4','14','1'),
 (364,'2019-11-11 13:00:00','2','XI-MIPA1 - Fisika UH 5 ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','10','9','14','1'),
 (365,'2019-11-11 13:40:00','2','XI-MIPA1 - Fisika UH 5 ( Jam Ke9) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','10','10','14','1'),
 (366,'2019-11-12 13:00:00','2','XII-MIPA4 - Biologi UH 5 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','9','14','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (367,'2019-11-12 13:40:00','2','XII-MIPA4 - Biologi UH 5 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','10','14','1'),
 (368,'2019-11-13 10:30:00','2','XII-MIPA3 - Biologi UH 5 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','6','14','1'),
 (369,'2019-11-13 11:10:00','2','XII-MIPA3 - Biologi UH 5 ( Jam Ke6) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','7','14','1'),
 (370,'2019-11-14 10:30:00','2','XII-MIPA2 - Biologi UH 5 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 3 (Lantai 3)','henrikadwi','57','20','6','14','3'),
 (371,'2019-11-14 11:10:00','2','XII-MIPA2 - Biologi UH 5 ( Jam Ke6) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 3 (Lantai 3)','henrikadwi','57','20','7','14','3'),
 (372,'2019-11-18 11:10:00','2','XII-MIPA3 - Biologi UH 5 ( Jam Ke6) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','7','14','1'),
 (373,'2019-11-18 12:20:00','2','XII-MIPA3 - Biologi UH 5 ( Jam Ke7) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','8','14','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (374,'2019-11-19 13:00:00','2','XII-MIPA4 - Biologi UH 5 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','9','14','1'),
 (375,'2019-11-19 13:40:00','2','XII-MIPA4 - Biologi UH 5 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','10','14','1'),
 (376,'2019-11-20 10:30:00','2','XII-MIPA3 - Biologi UH 5 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','6','14','1'),
 (377,'2019-11-20 11:10:00','2','XII-MIPA3 - Biologi UH 5 ( Jam Ke6) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','21','7','14','1'),
 (378,'2019-11-20 13:00:00','2','XII-MIPA2 - Biologi UH 5 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','9','14','1'),
 (379,'2019-11-20 13:40:00','2','XII-MIPA2 - Biologi UH 5 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','10','14','1'),
 (380,'2019-11-21 10:30:00','2','XII-MIPA2 - Biologi UH 5 ( Jam Ke5) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','6','14','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (381,'2019-11-21 11:10:00','2','XII-MIPA2 - Biologi UH 5 ( Jam Ke6) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','20','7','14','1'),
 (384,'2019-11-14 13:00:00','2','XII-MIPA4 - Biologi UH 5 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 3 (Lantai 3)','henrikadwi','57','22','9','14','3'),
 (385,'2019-11-14 13:40:00','2','XII-MIPA4 - Biologi UH 5 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 3 (Lantai 3)','henrikadwi','57','22','10','14','3'),
 (386,'2019-11-15 13:40:00','2','XI-NSC - Fisika UH 5 ( Jam Ke9) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','12','10','14','1'),
 (387,'2019-11-18 13:00:00','2','XI-MIPA4 - Fisika UH 5 ( Jam Ke8) - Theresia Anata, S. Pd. - LABKOM 1 (Lantai 1)','theresiaanata','41','14','9','14','1'),
 (388,'2019-11-14 09:10:00','2','XII-IPS2 - Sosiologi/Antropologi UH 3 ( Jam Ke3) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','27','4','4','1'),
 (389,'2019-11-14 09:50:00','2','XII-IPS2 - Sosiologi/Antropologi UH 3 ( Jam Ke4) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 1 (Lantai 1)','evarenanthya','47','27','5','4','1');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (390,'2019-11-21 09:10:00','2','XII-SSC - Biologi UH 5 ( Jam Ke3) - Christina Handoyo, S.Si - LABKOM 2 (Lantai 3)','christinahandoyo','20','33','4','14','2'),
 (391,'2019-11-21 11:10:00','2','X-MIPA3 - Biologi UH 6 ( Jam Ke6) - Christina Handoyo, S.Si - LABKOM 2 (Lantai 3)','christinahandoyo','20','3','7','15','2'),
 (392,'2019-11-21 13:40:00','2','X-MIPA2 - Biologi UH 6 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 2 (Lantai 3)','christinahandoyo','20','2','10','15','2'),
 (393,'2019-11-20 07:00:00','3','XII-MIPA1 - Biologi UH 6 ( Jam Ke1) - Christina Handoyo, S.Si - LABKOM 2 (Lantai 3)','christinahandoyo','20','19','1','15','2'),
 (394,'2019-11-20 09:50:00','3','X-MIPA4 - Biologi UH 5 ( Jam Ke4) - Christina Handoyo, S.Si - LABKOM 2 (Lantai 3)','christinahandoyo','20','4','5','14','2'),
 (395,'2019-11-20 13:40:00','2','X-MIPA1 - Biologi UH 5 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 2 (Lantai 3)','christinahandoyo','20','1','10','14','2'),
 (396,'0000-00-00 00:00:00','2','X-NSC - Biologi UH 5 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 2 (Lantai 3)','christinahandoyo','20','9','10','14','2');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (399,'2019-11-15 07:00:00','2','XI-MIPA2 - Fisika UH 6 ( Jam Ke1) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','11','1','15','1'),
 (400,'2019-11-15 07:40:00','2','XI-MIPA2 - Fisika UH 6 ( Jam Ke2) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','11','2','15','1'),
 (401,'2019-11-15 12:20:00','2','XI-MIPA3 - Fisika UH 6 ( Jam Ke7) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','13','8','15','1'),
 (402,'2019-11-15 13:00:00','2','XI-MIPA3 - Fisika UH 6 ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','13','9','15','1'),
 (403,'2019-11-18 07:00:00','2','X-MIPA1 - Fisika UH 5 ( Jam Ke1) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 1 (Lantai 1)','melianapantouw','70','1','1','14','1'),
 (404,'0000-00-00 00:00:00','2','XI-MIPA1 - Fisika UH 5 ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 3 (Lantai 3)','melianapantouw','70','10','9','14','3'),
 (405,'2019-11-18 13:00:00','2','XI-MIPA1 - Fisika UH 5 ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 3 (Lantai 3)','melianapantouw','70','10','9','14','3');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (406,'2019-11-19 11:10:00','2','XII-MIPA1 - Biologi UH 6 ( Jam Ke6) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','19','7','15','1'),
 (407,'0000-00-00 00:00:00','2','XII-IPS3 - Sosiologi/Antropologi UH 3 ( Jam Ke8) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','28','9','4','2'),
 (408,'0000-00-00 00:00:00','2','XII-IPS3 - Sosiologi/Antropologi UH 3 ( Jam Ke9) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 3 (Lantai 3)','evarenanthya','47','28','10','4','3'),
 (409,'0000-00-00 00:00:00','2','XII-IPS3 - Sosiologi/Antropologi UH 3 (Remidi) ( Jam Ke9) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 3 (Lantai 3)','evarenanthya','47','28','10','7','3'),
 (410,'2019-11-18 13:00:00','2','XII-IPS2 - Sosiologi/Antropologi UH 3 ( Jam Ke8) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','27','9','4','2'),
 (411,'2019-11-18 13:40:00','2','XII-IPS3 - Sosiologi/Antropologi UH 3 ( Jam Ke9) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','28','10','4','2'),
 (412,'2019-11-18 11:10:00','2','X-MIPA4 - Fisika UH 5 ( Jam Ke6) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 3 (Lantai 3)','melianapantouw','70','4','7','14','3');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (413,'2019-11-19 13:00:00','2','X-NSC - Biologi UH 5 ( Jam Ke8) - Christina Handoyo, S.Si - LABKOM 3 (Lantai 3)','christinahandoyo','20','9','9','14','3'),
 (414,'2019-11-19 13:40:00','2','X-NSC - Biologi UH 5 ( Jam Ke9) - Christina Handoyo, S.Si - LABKOM 3 (Lantai 3)','christinahandoyo','20','9','10','14','3'),
 (415,'2019-11-20 07:00:00','2','XII-MIPA1 - Biologi UH 6 ( Jam Ke1) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','19','1','15','1'),
 (416,'2019-11-20 09:50:00','2','X-MIPA4 - Biologi UH 5 ( Jam Ke4) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','4','5','14','1'),
 (417,'2019-11-20 09:10:00','2','XII-IPS1 - Sosiologi/Antropologi UH 3 ( Jam Ke3) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','26','4','4','2'),
 (418,'2019-11-20 09:50:00','2','XII-IPS1 - Sosiologi/Antropologi UH 3 ( Jam Ke4) - Eva Renanthya Grimaldi, S.Sos. - LABKOM 2 (Lantai 3)','evarenanthya','47','26','5','4','2'),
 (419,'0000-00-00 00:00:00','2','X-MIPA2 - Fisika UH 5 ( Jam Ke5) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 2 (Lantai 3)','melianapantouw','70','2','6','14','2');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (420,'2019-11-20 13:00:00','2','X-MIPA3 - Fisika UH 5 ( Jam Ke8) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 2 (Lantai 3)','melianapantouw','70','3','9','14','2'),
 (421,'2019-11-22 09:10:00','2','XI-MIPA1 - Biologi UH 3 (Remidi) ( Jam Ke3) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','10','4','7','1'),
 (422,'2019-11-22 09:50:00','2','X-MIPA2 - Biologi UH 3 (Remidi) ( Jam Ke4) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','2','5','7','1'),
 (423,'2019-11-22 10:30:00','2','X-MIPA3 - Biologi UH 3 (Remidi) ( Jam Ke5) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','3','6','7','1'),
 (424,'2019-11-20 10:30:00','2','X-MIPA2 - Fisika UH 5 ( Jam Ke5) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 2 (Lantai 3)','melianapantouw','70','2','6','14','2'),
 (425,'0000-00-00 00:00:00','2','X-MIPA4 - Biologi UH 3 (Remidi) ( Jam Ke6) - Christina Handoyo, S.Si - LABKOM 1 (Lantai 1)','christinahandoyo','20','4','7','7','1'),
 (426,'2019-11-21 10:30:00','3','X-MIPA2 - Fisika UH 5 ( Jam Ke5) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 3 (Lantai 3)','melianapantouw','70','2','6','14','3');
INSERT INTO `jadwalujian` (`id`,`tgl1`,`status`,`keterangan`,`guru`,`mapel`,`kelas`,`jam`,`ujian`,`labkom`) VALUES 
 (427,'2019-11-21 11:10:00','2','X-MIPA2 - Fisika UH 5 ( Jam Ke6) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 3 (Lantai 3)','melianapantouw','70','2','7','14','3'),
 (428,'2019-11-21 12:20:00','3','X-MIPA2 - Fisika UH 5 ( Jam Ke7) - M.V. Meliana Pantouw , S.Pd., S.H., M.Kn. - LABKOM 3 (Lantai 3)','melianapantouw','70','2','8','14','3'),
 (429,'2019-11-21 13:00:00','2','XII-MIPA4 - Biologi UH 6 ( Jam Ke8) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','9','15','1'),
 (430,'2019-11-21 13:40:00','2','XII-MIPA4 - Biologi UH 6 ( Jam Ke9) - Henrika Dwi Hendrastuti, S.Si. - LABKOM 1 (Lantai 1)','henrikadwi','57','22','10','15','1');
/*!40000 ALTER TABLE `jadwalujian` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`jam`
--
...
--
-- Dumping data for table `jadwalujian`.`jam`
--
...
--
-- Table structure for table `jadwalujian`.`kelas`
--
...
--
-- Dumping data for table `jadwalujian`.`kelas`
--
...
--
-- Table structure for table `jadwalujian`.`kelas_isi`
--

DROP TABLE IF EXISTS `kelas_isi`;
CREATE TABLE `kelas_isi` (
  `id` int(2) NOT NULL AUTO_INCREMENT,
  `kelas` varchar(255) NOT NULL,
...
--
-- Dumping data for table `jadwalujian`.`kelas_isi`
--

/*!40000 ALTER TABLE `kelas_isi` DISABLE KEYS */;
/*!40000 ALTER TABLE `kelas_isi` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`kelaskat`
--

DROP TABLE IF EXISTS `kelaskat`;
CREATE TABLE `kelaskat` (
  `id` int(2) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jadwalujian`.`kelaskat`
--

/*!40000 ALTER TABLE `kelaskat` DISABLE KEYS */;
INSERT INTO `kelaskat` (`id`,`kelaskat`) VALUES 
 (1,'IPA'),
 (2,'IPS');
/*!40000 ALTER TABLE `kelaskat` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`kursus_setting`
--

DROP TABLE IF EXISTS `kursus_setting`;
CREATE TABLE `kursus_setting` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `guru` varchar(255) NOT NULL,
...
--
-- Dumping data for table `jadwalujian`.`kursus_setting`
--

/*!40000 ALTER TABLE `kursus_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `kursus_setting` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`labkom`
--
...
--
-- Dumping data for table `jadwalujian`.`labkom`
--

/*!40000 ALTER TABLE `labkom` DISABLE KEYS */;
INSERT INTO `labkom` (`id`,`labkom`) VALUES 
 (1,'LABKOM 1 (Lantai 1)'),
 (2,'LABKOM 2 (Lantai 3)'),
 (3,'LABKOM 3 (Lantai 3)');
/*!40000 ALTER TABLE `labkom` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`mapel`
--
...
--
-- Dumping data for table `jadwalujian`.`mapel`
--
...
INSERT INTO `mapel` (`id`,`mapel`,`icon`,`kode`,`guru`) VALUES 
 ...
 (24,'Kimia/PKWU','','Kimia/PKWU','flavianaemmi'),
...
INSERT INTO `mapel` (`id`,`mapel`,`icon`,`kode`,`guru`) VALUES 
 ...
 (35,'Kimia/PKWU','','Kimia/PKWU','fransiskamartanti'),
 ...
 (43,'BK/PKWU','','BK/PKWU','choirulanwar'),
...
INSERT INTO `mapel` (`id`,`mapel`,`icon`,`kode`,`guru`) VALUES 
 ...
 (55,'Sejarah Indonesia','','SejarahIndonesia','albertushandang'),
 (56,'Matematika','','Matematika','rosulasri'),
 (57,'Biologi','','Biologi','henrikadwi'),
 (58,'PKWU/Ekonomi','','PKWU/Ekonomi','markustri'),
 (59,'Seni Rupa','','Seni Rupa','antoniusharitono'),
 (60,'Bahasa Indonesia','','Bahasa Indonesia','widikrismantari'),
 (61,'Seni Musik','','Seni Musik','caturmayangkoro'),
 (62,'Sejarah/Sejarah Indonesia','','Sejarah/Sejarah Indo','mariachristina'),
 (63,'Agama','','Agama','totowidijarto'),
 (64,'Bahasa Indonesia','','Bahasa Indonesia','panjidwi'),
 (65,'Sejarah/Sejarah Indonesia','','Sejarah/Sejarah Indo','erlinathomas'),
 (66,'Bhs. Inggris/BDSI','','Bhs. Inggris/BDSI','fabriziourso'),
 (67,'Bhs. Inggris/BDSI','','Bhs. Inggris/BDSI','herupurnomo'),
 (68,'Fisika','','Fisika','laurentiuswahyudiarj');
INSERT INTO `mapel` (`id`,`mapel`,`icon`,`kode`,`guru`) VALUES 
 (69,'Fisika','','Fisika','laurentiuswahyudiarj'),
 (70,'Fisika','','Fisika','melianapantouw'),
 (71,'PenJas','','PenJas','nurbetusdwi'),
 (72,'Kimia','','Kimia','octhansetyawan'),
 (73,'Matematika/Matematika Minat','','Matematika/Matematik','resticitraningtyas'),
 (74,'PKKN','','PKKN','srisayekti'),
 (75,'Matematika','','Matematika','stephanussulistyanto'),
 (76,'Bahasa Indonesia','','Bahasa Indonesia','estiningtyasutami'),
 (77,'Biologi','','Biologi','veronicaervina'),
 (78,'Matematika','','Matematika','stephanussulistyanto'),
 (79,'Matematika/Matematika Minat','','Matematika','stephanussulistyanto'),
 (80,'Matematika/Matematika Minat','','MAT','stephanussulistyanto'),
 (81,'asd','','asd','stephanussulistyanto'),
 (82,'Matematika/Matematika Minat','','Matematika','stephanussulistyantoro'),
 (83,'Fisika','','Fisika','laurentiuswahyudiarjo');
/*!40000 ALTER TABLE `mapel` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`mapel_icon`
--

DROP TABLE IF EXISTS `mapel_icon`;
CREATE TABLE `mapel_icon` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `icon` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `jadwalujian`.`mapel_icon`
--

/*!40000 ALTER TABLE `mapel_icon` DISABLE KEYS */;
INSERT INTO `mapel_icon` (`id`,`icon`) VALUES 
 ...
 (4,'icon04.jpg'),
 (5,'icon05.jpg');
/*!40000 ALTER TABLE `mapel_icon` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`master`
--
...
--
-- Dumping data for table `jadwalujian`.`master`
--
...
--
-- Table structure for table `jadwalujian`.`materi`
--
...
--
-- Dumping data for table `jadwalujian`.`materi`
--
...
--
-- Table structure for table `jadwalujian`.`menu`
--
...
--
-- Dumping data for table `jadwalujian`.`menu`
--
...
--
-- Table structure for table `jadwalujian`.`menu_guru`
--

DROP TABLE IF EXISTS `menu_guru`;
CREATE TABLE `menu_guru` (
...
--
-- Dumping data for table `jadwalujian`.`menu_guru`
--

/*!40000 ALTER TABLE `menu_guru` DISABLE KEYS */;
/*!40000 ALTER TABLE `menu_guru` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`menu_siswa`
--
...
--
-- Dumping data for table `jadwalujian`.`menu_siswa`
--

/*!40000 ALTER TABLE `menu_siswa` DISABLE KEYS */;
/*!40000 ALTER TABLE `menu_siswa` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`modul`
--
...
--
-- Dumping data for table `jadwalujian`.`modul`
--
...
--
-- Table structure for table `jadwalujian`.`multiupload`
--
...
--
-- Dumping data for table `jadwalujian`.`multiupload`
--

/*!40000 ALTER TABLE `multiupload` DISABLE KEYS */;
/*!40000 ALTER TABLE `multiupload` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`pengumuman_sekolah`
--
...
--
-- Dumping data for table `jadwalujian`.`pengumuman_sekolah`
--
...
--
-- Table structure for table `jadwalujian`.`pertemuan`
--
...
--
-- Dumping data for table `jadwalujian`.`pertemuan`
--
...
--
-- Table structure for table `jadwalujian`.`phpmysqlautobackup`
--
...
--
-- Dumping data for table `jadwalujian`.`phpmysqlautobackup`
--
...
--
-- Table structure for table `jadwalujian`.`phpmysqlautobackup_log`
--
...
--
-- Dumping data for table `jadwalujian`.`phpmysqlautobackup_log`
--
...
--
-- Table structure for table `jadwalujian`.`post`
--
...
--
-- Dumping data for table `jadwalujian`.`post`
--
...
--
-- Table structure for table `jadwalujian`.`semester`
--
...
--
-- Dumping data for table `jadwalujian`.`semester`
--
...
--
-- Table structure for table `jadwalujian`.`sensor`
--
...
--
-- Dumping data for table `jadwalujian`.`sensor`
--
...
--
-- Table structure for table `jadwalujian`.`session`
--
...
--
-- Dumping data for table `jadwalujian`.`session`
--
...
--
-- Table structure for table `jadwalujian`.`session_isi`
--

DROP TABLE IF EXISTS `session_isi`;
CREATE TABLE `session_isi` (
  `id` int(2) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jadwalujian`.`session_isi`
--

/*!40000 ALTER TABLE `session_isi` DISABLE KEYS */;
/*!40000 ALTER TABLE `session_isi` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`situs`
--
...
--
-- Dumping data for table `jadwalujian`.`situs`
--
...
--
-- Table structure for table `jadwalujian`.`soal`
--
...
--
-- Dumping data for table `jadwalujian`.`soal`
--
...
--
-- Table structure for table `jadwalujian`.`t_jurusan`
--
...
--
-- Dumping data for table `jadwalujian`.`t_jurusan`
--
...
--
-- Table structure for table `jadwalujian`.`tahunajaran`
--
...
--
-- Dumping data for table `jadwalujian`.`tahunajaran`
--
...
--
-- Table structure for table `jadwalujian`.`tbl_kalender`
--
...
--
-- Dumping data for table `jadwalujian`.`tbl_kalender`
--
...
--
-- Table structure for table `jadwalujian`.`tbl_user`
--
...
--
-- Dumping data for table `jadwalujian`.`tbl_user`
--
...
--
-- Table structure for table `jadwalujian`.`tipeujian`
--

DROP TABLE IF EXISTS `tipeujian`;
CREATE TABLE `tipeujian` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) NOT NULL,
...
--
-- Dumping data for table `jadwalujian`.`tipeujian`
--

/*!40000 ALTER TABLE `tipeujian` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipeujian` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`topik`
--
...
--
-- Dumping data for table `jadwalujian`.`topik`
--
...
--
-- Table structure for table `jadwalujian`.`tugas`
--
...
--
-- Dumping data for table `jadwalujian`.`tugas`
--
...
--
-- Table structure for table `jadwalujian`.`tugaskomentar`
--

DROP TABLE IF EXISTS `tugaskomentar`;
CREATE TABLE `tugaskomentar` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `tgl` date NOT NULL,
...
--
-- Dumping data for table `jadwalujian`.`tugaskomentar`
--

/*!40000 ALTER TABLE `tugaskomentar` DISABLE KEYS */;
/*!40000 ALTER TABLE `tugaskomentar` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`tugassiswa`
--
...
--
-- Dumping data for table `jadwalujian`.`tugassiswa`
--

/*!40000 ALTER TABLE `tugassiswa` DISABLE KEYS */;
/*!40000 ALTER TABLE `tugassiswa` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`ujian`
--
...
--
-- Dumping data for table `jadwalujian`.`ujian`
--
...
--
-- Table structure for table `jadwalujian`.`ujianguru`
--

DROP TABLE IF EXISTS `ujianguru`;
CREATE TABLE `ujianguru` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jadwalujian`.`ujianguru`
--

/*!40000 ALTER TABLE `ujianguru` DISABLE KEYS */;
/*!40000 ALTER TABLE `ujianguru` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`ujianhari`
--

DROP TABLE IF EXISTS `ujianhari`;
CREATE TABLE `ujianhari` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jadwalujian`.`ujianhari`
--

/*!40000 ALTER TABLE `ujianhari` DISABLE KEYS */;
/*!40000 ALTER TABLE `ujianhari` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`ujianharijam`
--

DROP TABLE IF EXISTS `ujianharijam`;
CREATE TABLE `ujianharijam` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `tahunajaran` varchar(50) NOT NULL,
  `semester` varchar(50) NOT NULL,
  `tipeujian` varchar(50) NOT NULL,
...
--
-- Dumping data for table `jadwalujian`.`ujianharijam`
--

/*!40000 ALTER TABLE `ujianharijam` DISABLE KEYS */;
/*!40000 ALTER TABLE `ujianharijam` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`ujianharijamsusulan`
--

DROP TABLE IF EXISTS `ujianharijamsusulan`;
CREATE TABLE `ujianharijamsusulan` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `tahunajaran` varchar(50) NOT NULL,
  `semester` varchar(50) NOT NULL,
  `tipeujian` varchar(50) NOT NULL,
...
--
-- Dumping data for table `jadwalujian`.`ujianharijamsusulan`
--

/*!40000 ALTER TABLE `ujianharijamsusulan` DISABLE KEYS */;
/*!40000 ALTER TABLE `ujianharijamsusulan` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`ujianharisusulan`
--

DROP TABLE IF EXISTS `ujianharisusulan`;
CREATE TABLE `ujianharisusulan` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `idhari` varchar(5) NOT NULL,
  `tgl` varchar(50) NOT NULL,
  `idmapel` varchar(50) NOT NULL,
...
--
-- Dumping data for table `jadwalujian`.`ujianharisusulan`
--

/*!40000 ALTER TABLE `ujianharisusulan` DISABLE KEYS */;
/*!40000 ALTER TABLE `ujianharisusulan` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`ujiannilai`
--

DROP TABLE IF EXISTS `ujiannilai`;
CREATE TABLE `ujiannilai` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `tgl` date NOT NULL,
  `jam` time NOT NULL,
  `idujian` varchar(50) NOT NULL,
...
--
-- Dumping data for table `jadwalujian`.`ujiannilai`
--

/*!40000 ALTER TABLE `ujiannilai` DISABLE KEYS */;
/*!40000 ALTER TABLE `ujiannilai` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`ujiansetting`
--

DROP TABLE IF EXISTS `ujiansetting`;
CREATE TABLE `ujiansetting` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jadwalujian`.`ujiansetting`
--

/*!40000 ALTER TABLE `ujiansetting` DISABLE KEYS */;
/*!40000 ALTER TABLE `ujiansetting` ENABLE KEYS */;


--
-- Table structure for table `jadwalujian`.`useraura`
--
...
) ENGINE=MyISAM AUTO_INCREMENT=5791 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `jadwalujian`.`useraura`
--
...
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 (1,'admin','10e01b4500dec5cccf9e851afacf4410','Administrator','aktif',1,'2019-10-28 12:20:17','2010-08-27 00:00:00','2034-08-27 00:00:00','Administrator','','sembunyikan','sembunyikan','','','Frateran2018..?','','','',''),
 (68,'superadmin','b11d5ece6353d17f85c5ad30e0a02360','Administrator','aktif',1,'2019-09-10 10:40:02','0000-00-00 00:00:00','0000-00-00 00:00:00','','','sembunyikan','sembunyikan','','','','','','',''),
 (5779,'markustri','a605299085d36ad7ec3c37bfc7ea1a18','Guru','aktif',1,'2019-09-09 10:30:37','0000-00-00 00:00:00','0000-00-00 00:00:00','Markus Tri Wibowo , S.Pd.','','sembunyikan','sembunyikan','','','markustri6571','','','','39'),
...
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 (5776,'laurentiuswahyudiarjo','33f33531f21803f0c420963e047efc6f','Guru','aktif',1,'2019-08-31 07:14:15','0000-00-00 00:00:00','0000-00-00 00:00:00','Laurentius Wahyudiarjo , S.Pd.','','sembunyikan','sembunyikan','','','laurentiuswahyudiarjo5176','','','','36'),
 (5775,'herupurnomo','5bf68c1cde331714940a8edc78dbdc54','Guru','aktif',0,'2019-10-16 13:50:52','0000-00-00 00:00:00','0000-00-00 00:00:00','Heru Purnomo','','sembunyikan','sembunyikan','','','herupurnomo7614','','','','35'),
 (5774,'henrikadwi','73f8ac2afd1b3131648571c329a1e2f0','Guru','aktif',1,'2019-09-03 14:42:18','0000-00-00 00:00:00','0000-00-00 00:00:00','Henrika Dwi Hendrastuti, S.Si.','','sembunyikan','sembunyikan','','','henrikadwi5737','','','','34'),
...
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 ...
 (5767,'evarenanthya','3d085f6a8a9e861a6723abf70f7b0d4f','Guru','aktif',1,'2019-11-19 14:36:15','0000-00-00 00:00:00','0000-00-00 00:00:00','Eva Renanthya Grimaldi, S.Sos.','','sembunyikan','sembunyikan','','','evarenanthya3148','','','','27');
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 ...
 (5762,'bernadusedy','4fd9528179dbbff2446cd72c06a11d68','Guru','aktif',1,'2019-09-11 12:32:33','0000-00-00 00:00:00','0000-00-00 00:00:00','Drs. Bernadus Edy Gunarso','','sembunyikan','sembunyikan','','','bernadusedy9028','','','','22'),
...
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 ...
 (5754,'christinahandoyo','81e425005c45e658548c47438b16faed','Guru','aktif',1,'2019-11-21 10:48:39','0000-00-00 00:00:00','0000-00-00 00:00:00','Christina Handoyo, S.Si','','sembunyikan','sembunyikan','','','christinahandoyo2071','','','','14'),
...
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 ...
 (5743,'albertushandang','6363ad5cc818a7d6431203e254aed946','Guru','aktif',1,'2019-09-02 10:41:56','0000-00-00 00:00:00','0000-00-00 00:00:00','Albertus Handang Budi Karya , S.Pd.','','sembunyikan','sembunyikan','','','albertushandang2413','','','','03'),
...
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 ...
 (5740,'budiadmin','aba400c9477b52f3d4dfa1a4bc690288','Administrator','aktif',0,'2019-11-21 11:51:09','0000-00-00 00:00:00','0000-00-00 00:00:00','Budi Santoso','','sembunyikan','sembunyikan','budi@frateran.sch.id','','budiadmin','','','','999');
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 ...
 (5782,'octhansetyawan','88d1648afdde25f89237e3d135bdbb1a','Guru','aktif',1,'2019-09-05 08:13:30','0000-00-00 00:00:00','0000-00-00 00:00:00','Octhan Setyawan, S.Si.','','sembunyikan','sembunyikan','','','octhansetyawan2497','','','','42');
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
 ...
 (5785,'stephanussulistyantoro','2e0c449d1c325ba8cb94aa74602de53a','Guru','aktif',1,'2019-10-28 09:04:01','0000-00-00 00:00:00','0000-00-00 00:00:00','Stephanus Sulistyantoro , M.Pd.','','sembunyikan','sembunyikan','','','abhista0302taka0109','','','','45'),
 ...
 (5787,'theresiaanata','59875df89eedc288ff089d92c9321955','Guru','aktif',1,'2019-11-12 13:54:11','0000-00-00 00:00:00','0000-00-00 00:00:00','Theresia Anata, S. Pd.','','sembunyikan','sembunyikan','','','theresiaanata4561','','','','47');
INSERT INTO `useraura` (`UserId`,`user`,`password`,`level`,`tipe`,`is_online`,`last_ping`,`start`,`exp`,`nama`,`photo`,`statusemail`,`statustelp`,`email`,`telp`,`password2`,`tahunajaran`,`kelas`,`absen`,`urutan`) VALUES 
...
--
-- Table structure for table `jadwalujian`.`usercounter`
--
...
--
-- Dumping data for table `jadwalujian`.`usercounter`
--
...
--
-- Table structure for table `jadwalujian`.`useronline`
--
...
--
-- Dumping data for table `jadwalujian`.`useronline`
--
...
--
-- Table structure for table `jadwalujian`.`useronlineday`
--
...
CREATE TABLE `useronlineday` (
  ...
  KEY `timevisit` (`timevisit`),
  KEY `ipproxy` (`ipproxy`)
) ENGINE=MyISAM AUTO_INCREMENT=5597 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `jadwalujian`.`useronlineday`
--
...
--
-- Table structure for table `jadwalujian`.`useronlinemonth`
--
...
CREATE TABLE `useronlinemonth` (
  ...
  KEY `timevisit` (`timevisit`),
  KEY `ipproxy` (`ipproxy`)
) ENGINE=MyISAM AUTO_INCREMENT=3871 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `jadwalujian`.`useronlinemonth`
--
